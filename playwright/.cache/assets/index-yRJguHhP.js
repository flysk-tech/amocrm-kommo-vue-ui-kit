const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/ButtonPrimaryPlayground-BP5D_HbL.js","assets/Button.themes-BIVBibom.js","assets/Button-87xfUlF2.css","assets/ButtonNeutralPlayground-PTOcfaDU.js","assets/ButtonSecondaryPlayground-CHoWQ-Pi.js"])))=>i.map(i=>d[i]);
...
const _Users_anton_projects_amocrm_vue_ui_kit_amocrm_vue_ui_kit_src_components_Button___tests___ButtonPrimaryPlayground_vue = () => __vitePreload(() => import('./ButtonPrimaryPlayground-BP5D_HbL.js'),true              ?__vite__mapDeps([0,1,2]):void 0).then((mod) => mod.default);
const _Users_anton_projects_amocrm_vue_ui_kit_amocrm_vue_ui_kit_src_components_Button___tests___ButtonNeutralPlayground_vue = () => __vitePreload(() => import('./ButtonNeutralPlayground-PTOcfaDU.js'),true              ?__vite__mapDeps([3,1,2]):void 0).then((mod) => mod.default);
const _Users_anton_projects_amocrm_vue_ui_kit_amocrm_vue_ui_kit_src_components_Button___tests___ButtonSecondaryPlayground_vue = () => __vitePreload(() => import('./ButtonSecondaryPlayground-CHoWQ-Pi.js'),true              ?__vite__mapDeps([4,1,2]):void 0).then((mod) => mod.default);
__pwRegistry.initialize({ _Users_anton_projects_amocrm_vue_ui_kit_amocrm_vue_ui_kit_src_components_Button___tests___ButtonPrimaryPlayground_vue,
  _Users_anton_projects_amocrm_vue_ui_kit_amocrm_vue_ui_kit_src_components_Button___tests___ButtonNeutralPlayground_vue,
  _Users_anton_projects_amocrm_vue_ui_kit_amocrm_vue_ui_kit_src_components_Button___tests___ButtonSecondaryPlayground_vue });

export { Fragment as F, createVNode as a, createSlots as b, createBlock as c, defineComponent as d, createTextVNode as e, createBaseVNode as f, onMounted as g, watch as h, isVNode as i, computed as j, createElementBlock as k, renderList as l, mergeProps as m, normalizeClass as n, openBlock as o, ref as p, watchEffect as q, renderSlot as r, createCommentVNode as s, toDisplayString as t, withCtx as w };
//# sourceMappingURL=index-yRJguHhP.js.map
